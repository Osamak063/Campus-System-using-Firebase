...
public class CompanyAdmin extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_company_admin, container, false);
        firebaseDatabase= FirebaseDatabase.getInstance();
        reference=firebaseDatabase.getReference().child("Users");
        listView_users_admin= (ListView) view.findViewById(R.id.company_admin_listview);
        ...
        childEventListener = new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                if(user1.getType().equals("company")){
